const AboutSection = () => {
  return (
    <section className="min-h-svh bg-background flex items-center justify-center py-10 sticky top-0">
      <div className="mx-auto w-full max-w-screen-desktop px-10 relative mb-40">
        <div className="h-20 flex items-center justify-center bg-blue-950 rounded p-4 sticky top-0">
          <p className="text-xl text-red-500 w-full font-semibold">
            Nossa História
          </p>
        </div>
        ...
        <div className="space-y-5 p-2 tablet:p-5">
          ...
          <p className="text-justify">
            ...
            itaque perspiciatis rem iste eaque eum sapiente minus ut atque sunt.
            Cum alias mollitia sit dolorum placeat aut ipsam nihil ut omnis
            modi.
          </p>
          ...
          <p className="text-justify">
            ...
            Est maxime doloribus quo commodi molestias ad suscipit repellat ut
            itaque perspiciatis rem iste eaque eum sapiente minus ut atque sunt.
            Rem perferendis praesentium rem omnis odit nam aliquam voluptatem ad
            suscipit corrupti nam recusandae veritatis. Id voluptatem explicabo
            est omnis suscipit ut repellendus sunt?
          </p>
        </div>
      </div>
    </section>
